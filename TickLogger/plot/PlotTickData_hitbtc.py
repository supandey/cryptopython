...
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_hitbtc_20171007_184846.log'
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_hitbtc_20171007_045053.log'
filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_hitbtc_20171006_203323.log'
...
dfDASH_USD, maskTrdDASH_USD, minYDASH_USD, maxYDASH_USD = getExchange('DASHUSD', dfALL)
dfXMR_USD, maskTrdXMR_USD, minYXMR_USD, maxYXMR_USD = getExchange('XMRUSD', dfALL)
dfZEC_USD, maskTrdZEC_USD, minYZEC_USD, maxYZEC_USD = getExchange('ZECUSD', dfALL)
...
plt.figure(7)
plotExchange(111, dfDASH_USD, maskTrdDASH_USD, minYDASH_USD, maxYDASH_USD)
plt.show()


plt.figure(8)
plotExchange(111, dfXMR_USD, maskTrdXMR_USD, minYXMR_USD, maxYXMR_USD)
plt.show()


plt.figure(9)
plotExchange(111, dfZEC_USD, maskTrdZEC_USD, minYZEC_USD, maxYZEC_USD)
plt.show()
