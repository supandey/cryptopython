...
df_gdax, maskTrd_gdax, minY_gdax, maxY_gdax = openFile(filenameGDAX, 'LTC-USD', timeStart, timeEnd)
df_bitfinex, maskTrd_bitfinex, minY_bitfinex, maxY_bitfinex = openFile(filenameBITFINEX, 'LTCUSD', timeStart, timeEnd)
df_poloniex, maskTrd_poloniex, minY_poloniex, maxY_poloniex = openFile(filenamePOLONIEX, 'USDT_LTC', timeStart, timeEnd)

print('\n gdax: {} bitfinex: {} poloniex: {} '.format(df_gdax.shape[0], df_bitfinex.shape[0], df_poloniex.shape[0]))
...
plt.figure(4)
ax1 = plotExchange(311, df_gdax, maskTrd_gdax, minY_gdax, maxY_gdax, 'gdax LTC', None, False, False)
plotExchange(312, df_bitfinex, maskTrd_bitfinex, minY_bitfinex, maxY_bitfinex, 'bitfinex', ax1, False)
plotExchange(313, df_poloniex, maskTrd_poloniex, minY_poloniex, maxY_poloniex, 'poloniex', ax1, True)
plt.show()
...
plt.figure(7)
ax1 = plt.subplot(111)
npts = min(df_gdax_1sec.shape[0], df_bitfinex_1sec.shape[0], df_poloniex_1sec.shape[0] ) - 1
...
plt.title('Differences in pc LTC', fontsize=18)
plt.xlabel('Time', fontsize=18)
