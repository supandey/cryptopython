...
df_gdax, maskTrd_gdax, minY_gdax, maxY_gdax = openFile(filenameGDAX, 'BTC-USD', timeStart, timeEnd)
df_kraken, maskTrd_kraken, minY_kraken, maxY_kraken = openFile(filenameKRAKEN, 'XXBTZUSD', timeStart, timeEnd)
df_bitfinex, maskTrd_bitfinex, minY_bitfinex, maxY_bitfinex = openFile(filenameBITFINEX, 'BTCUSD', timeStart, timeEnd)
df_poloniex, maskTrd_poloniex, minY_poloniex, maxY_poloniex = openFile(filenamePOLONIEX, 'USDT_BTC', timeStart, timeEnd)
df_gemini, maskTrd_gemini, minY_gemini, maxY_gemini = openFile(filenameGEMINI, 'btcusd', timeStart, timeEnd)
...
plt.figure(6)
ax1 = plotExchange(511, df_gdax, maskTrd_gdax, minY_gdax, maxY_gdax, 'gdax BTC', None, False, False)
plotExchange(512, df_kraken, maskTrd_kraken, minY_kraken, maxY_kraken, 'kraken', ax1, False, False)
plotExchange(513, df_bitfinex, maskTrd_bitfinex, minY_bitfinex, maxY_bitfinex, 'bitfinex', ax1, False, False)
plotExchange(514, df_poloniex, maskTrd_poloniex, minY_poloniex, maxY_poloniex, 'poloniex', ax1, False, False)
plotExchange(515, df_gemini, maskTrd_gemini, minY_gemini, maxY_gemini, 'gemini', ax1, True, False)
plt.show()
...
plt.title('Differences in pc BTC', fontsize=18)
plt.xlabel('Time', fontsize=18)
