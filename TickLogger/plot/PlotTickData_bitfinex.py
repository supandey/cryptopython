...
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_bitfinex_20171009_211629.log'
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_bitfinex_20171009_091304.log'
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_bitfinex_20171008_115409.log'
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_bitfinex_20171007_184833.log'
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_bitfinex_20171007_045040.log'
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_bitfinex_20170922_080628.log'
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_bitfinex_20170921_134159.log'
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_bitfinex_20170920_063532.log'
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_bitfinex_20170919_142639.log'
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_bitfinex_20170914_224245.log'
filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_bitfinex_20170918_205051.log'
...
dfBTC_USD, maskTrdBTC_USD, minYBTC_USD, maxYBTC_USD = getExchange('BTCUSD', dfALL)
dfETH_USD, maskTrdETH_USD, minYETH_USD, maxYETH_USD = getExchange('ETHUSD', dfALL)
dfLTC_USD, maskTrdLTC_USD, minYLTC_USD, maxYLTC_USD = getExchange('LTCUSD', dfALL)
dfLTC_BTC, maskTrdLTC_BTC, minYLTC_BTC, maxYLTC_BTC = getExchange('LTCBTC', dfALL)
dfETH_BTC, maskTrdETH_BTC, minYETH_BTC, maxYETH_BTC = getExchange('ETHBTC', dfALL)

dfOMG_USD, maskTrdOMG_USD, minYOMG_USD, maxYOMG_USD = getExchange('OMGUSD', dfALL)
dfIOTA_USD, maskTrdIOTA_USD, minYIOTA_USD, maxYIOTA_USD = getExchange('IOTAUSD', dfALL)
dfXRP_USD, maskTrdXRP_USD, minYXRP_USD, maxYXRP_USD = getExchange('XRPUSD', dfALL)

#'BTCUSD', 'ETHUSD', 'LTCUSD', 'OMGUSD', 'IOTAUSD', 'ETHBTC', 'LTCBTC', 'OMGBTC', 'IOTABTC', 'EOSUSD', 'XRPUSD', 'SANUSD'
...
plt.figure(7)
plotExchange(111, dfOMG_USD, maskTrdOMG_USD, minYOMG_USD, maxYOMG_USD)
plt.show()
...
plt.figure(9)
plotExchange(111, dfIOTA_USD, maskTrdIOTA_USD, minYIOTA_USD, maxYIOTA_USD)
plt.show()
