...
#filename = r'\\awcnas4\QAR\Research\Data\Sanjeev\crypto\Tick_gemini_20171012_192902.log'
...
plt.figure(2)
plotExchange(111, dfBTC_USD, maskTrdBTC_USD, minYBTC_USD, maxYBTC_USD, 'Gemini BTC', None, True)
plt.show()

plt.figure(3)
plotExchange(111, dfETH_USD, maskTrdETH_USD, minYETH_USD, maxYETH_USD, 'Gemini ETC', None, True)
plt.show()

plt.figure(4)
plotExchange(111, dfETH_BTC, maskTrdETH_BTC, minYETH_BTC, maxYETH_BTC, 'Gemini BTC-ETH', None, True)
plt.show()

plt.figure(5)
ax1 = plotExchange(311, dfBTC_USD, maskTrdBTC_USD, minYBTC_USD, maxYBTC_USD, 'BTC Gemini', None, False, False)
plotExchange(312, dfETH_USD, maskTrdETH_USD, minYETH_USD, maxYETH_USD, 'ETH', ax1, False, False)
plotExchange(313, dfETH_BTC, maskTrdETH_BTC, minYETH_BTC, maxYETH_BTC, 'BTC-ETH', ax1, True, False)
plt.show()
